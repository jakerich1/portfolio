      ...
      <FlexContainer column={size.width < 500 ? 1 : 0} align="center" gap="2em">
        <FlexContainer column justify="center">
          ...
          <FlexContainer
            align="center"
            gap="0.75em"
            justify={size.width < 500 ? 'center' : 'flex-start'}
            padding="10px 0 0 0"
          >
            <SocialCont
              animate={{ opacity: 1 }}
              ...
              href="https://uk.linkedin.com/in/jacob-riches"
              target="_blank"
            >
            ...
            <SocialCont
              ...
              href="https://github.com/jakerich1"
              target="_blank"
            >
            ...
            <SocialCont
              ...
              href="https://stackoverflow.com/users/9318217/jacob-riches"
              target="_blank"
            >
